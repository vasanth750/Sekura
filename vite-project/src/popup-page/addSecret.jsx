...
export default function AddSecret({ closePopup, onSecretCreated }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm">
      <div className="w-full max-w-[600px] rounded-2xl border border-white/10 bg-slate-950/95 p-6 shadow-2xl shadow-black/40">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="relative">
            <input
              ...
              className="w-full rounded-xl border border-white/10 bg-slate-950/50 px-4 py-3 pr-12 text-white outline-none transition placeholder:text-slate-500 focus:border-cyan-300/70 focus:ring-2 focus:ring-cyan-400/25"
            />

            <button
              type="button"
              className="absolute right-3 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-lg text-slate-400 transition hover:bg-white/10 hover:text-cyan-100"
